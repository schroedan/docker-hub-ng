...
[![Build Status](https://travis-ci.org/schroedan/docker-hub-ng.svg?branch=8.1)](https://travis-ci.org/schroedan/docker-hub-ng)

## Supported Tags And Respective `Dockerfile` Links

* `8.1.2`, `8.1.1`, `8.1.0`, `8.1` ([Dockerfile](https://github.com/schroedan/docker-hub-ng/blob/8.1/8.1/Dockerfile))
