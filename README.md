...
[![Build Status](https://travis-ci.org/schroedan/docker-hub-ng.svg?branch=8.2)](https://travis-ci.org/schroedan/docker-hub-ng)

## Supported Tags And Respective `Dockerfile` Links

* `8.2.1`, `8.2.0`, `8.2` ([Dockerfile](https://github.com/schroedan/docker-hub-ng/blob/8.2/8.2/Dockerfile))
